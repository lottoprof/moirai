...
Будет описан отдельно когда методисты пришлют первые тела модулей. Сейчас
зафиксированы только метаданные. См. `decisions_archive.md` 2026-05-19
§student_book для текущего contract'а.
